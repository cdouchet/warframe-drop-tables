...
* @returns {any}
*/
export function parse_warframe_data(data) {
    const ptr0 = passStringToWasm0(data, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.parse_warframe_data(ptr0, len0);
...
* @returns {any}
*/
export function filter_warframe_missions(missions, filter) {
    const ptr0 = passStringToWasm0(filter, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.filter_warframe_missions(addHeapObject(missions), ptr0, len0);
    return takeObject(ret);
}
